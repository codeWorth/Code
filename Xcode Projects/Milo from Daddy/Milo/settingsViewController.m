...
- (void)viewDidLoad
{
    ...
    UIImageView *titleView = [[UIImageView alloc]initWithFrame:CGRectMake(-9, 0, titleImage.size.width/2.1, titleImage.size.height/1.95)];
    UIView *titleContainer = [[UIView alloc] initWithFrame:CGRectMake(0, 0, titleImage.size.width/2.1, titleImage.size.height/1.95)];
