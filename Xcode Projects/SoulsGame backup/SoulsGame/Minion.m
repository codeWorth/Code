...
-(instancetype)initWithHealth:(NSInteger)health Speed:(NSInteger)speed shield:(NSInteger)shield andOwner:(Player*)owner{
    if ((self = [super init]) && speed+health+shield == [Minion BASE_STATS_TOTAL]){
        ...
        self.affectedCooldown -= self._speed.amount;
