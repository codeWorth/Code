...
elif (x.dtype != "int32"): #if the input array has entries with differing numbers of inputs
    print("Invalid input matrix")
    sys.exit(0)
    
elif (y.dtype != "int32"): #if the output array has entries with differing numbers of outputs
